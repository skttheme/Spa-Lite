        ...
        <?php } ?>
         <div class="copyright-wrapper">
        	<div class="container">
            	 ...
            	 <div class="design-by"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','spa-lite');?> <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-spa-wordpress-theme/');?>" target="_blank">
        <?php esc_html_e('Spa Lite','spa-lite'); ?>
        </a></div>
                 <div class="clear"></div>
            </div>           
        </div>
