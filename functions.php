...
define('SPA_LITE_SKTTHEMES_URL','https://www.sktthemes.org');
define('SPA_LITE_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/spa-wordpress-theme/');
define('SPA_LITE_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-spa-wordpress-theme/');
define('SPA_LITE_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/skt-spa-documentation/');
define('SPA_LITE_SKTTHEMES_LIVE_DEMO','https://sktperfectdemo.com/demos/spa/');
define('SPA_LITE_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/');
/**
...
add_action( 'tgmpa_register', 'spa_lite_register_required_plugins' );
 
function spa_lite_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
