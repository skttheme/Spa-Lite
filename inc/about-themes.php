...
<div class="wrapper-info">
	...
	<div class="col-right">			
			<div class="centerbold">
				<hr />
				<a href="<?php echo esc_url(SPA_LITE_SKTTHEMES_LIVE_DEMO); ?>" target="_blank"><?php esc_html_e('Live Demo', 'spa-lite'); ?></a> | 
				<a href="<?php echo esc_url(SPA_LITE_SKTTHEMES_PRO_THEME_URL); ?>"><?php esc_html_e('Buy Pro', 'spa-lite'); ?></a> | 
				<a href="<?php echo esc_url(SPA_LITE_SKTTHEMES_THEME_DOC); ?>" target="_blank"><?php esc_html_e('Documentation', 'spa-lite'); ?></a>
